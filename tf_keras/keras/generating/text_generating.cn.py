...
def transformer_model():
    ...
    sample_transformer = Transformer(
        num_layers=4, d_model=64, num_heads=8, dff=256,
...
if __name__ == '__main__':
    ...
    word_len = len(tokenizer_cn.word_index)
    '''
    # label encoder 编码
    ...
    # 使用dataset代替 自己的生成器
    dataset = tf.data.Dataset.from_tensor_slices(index_array[20000:30000])
    ...
    '''
    # transformer收敛效果很差，原因不明,可能是输出太小的缘故，导致decoder的通道太小，将decoder layer减小的到一层后，有一定好转
