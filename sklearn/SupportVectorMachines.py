...
plt.plot(x, y_pred1, c='green', label='svm_poly_reg1')
plt.plot(x, y_pred2, c='red', label='svm_poly_reg2')
plt.plot(x, y_pred3, c='yellow', label='svm_poly_reg3')
plt.plot(x, y_pred4, c='blue', label='svm_poly_reg4')
plt.legend()
